def optimal_change(item_cost, amount_paid):
    ...
    if(item_cost == amount_paid):
        print("Wow, You've payed with exact change and made this assessment way easier for me!")
    
    #When item cost isn't met by amount paid
    elif(item_cost > amount_paid):
        print("Uh oh, Looks like you haven't paid enough!")
    ...
    #When amount paid is greater than item cost and we need to give change
        ...
        #create string to be added to, depending on number of occurances              
        added_string = ''

        for i in dict_of_change_values:
            #plural and singular if statements
